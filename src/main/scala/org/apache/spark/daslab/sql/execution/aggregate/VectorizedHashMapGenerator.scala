...
import org.apache.spark.daslab.sql.execution.vectorized.{MutableColumnarRow, OnHeapColumnVector}
...
class VectorizedHashMapGenerator(
   ...
   * associated [[org.apache.spark.daslab.sql.execution.vectorized.OnHeapColumnVector]]. For instance,
   ...
   * [[org.apache.spark.daslab.sql.execution.vectorized.MutableColumnarRow]] which keeps track of the
   ...
   * [[org.apache.spark.daslab.sql.execution.vectorized.OnHeapColumnVector]]. For instance, if we

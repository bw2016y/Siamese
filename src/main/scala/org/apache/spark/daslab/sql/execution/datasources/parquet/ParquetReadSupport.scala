...
private[parquet] object ParquetReadSupport {
  val SPARK_ROW_REQUESTED_SCHEMA = "org.apache.spark.daslab.sql.parquet.row.requested_schema"

  val SPARK_METADATA_KEY = "org.apache.spark.daslab.sql.parquet.row.metadata"

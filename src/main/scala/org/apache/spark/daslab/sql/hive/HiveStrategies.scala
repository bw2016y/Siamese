...
package org.apache.spark.daslab.sql.hive
...
import org.apache.spark.daslab.sql.engine.plans.logical.{InsertIntoDir, InsertIntoTable, LogicalPlan,
    ScriptTransformation}
import org.apache.spark.daslab.sql.engine.rules.Rule
import org.apache.spark.daslab.sql.execution._
import org.apache.spark.daslab.sql.execution.command.{CreateTableCommand, DDLUtils}
import org.apache.spark.daslab.sql.execution.datasources.{CreateTable, LogicalRelation}
import org.apache.spark.daslab.sql.execution.datasources.parquet.{ParquetFileFormat, ParquetOptions}
import org.apache.spark.daslab.sql.hive.execution._
import org.apache.spark.daslab.sql.internal.{HiveSerDe, SQLConf}
    ...
    if (serde.contains("parquet")) {
      ...
      if (conf.getConf(SQLConf.ORC_IMPLEMENTATION) == "native") {
        sessionCatalog.metastoreCatalog.convertToLogicalRelation(
          relation,
          options,
          classOf[org.apache.spark.daslab.sql.execution.datasources.orc.OrcFileFormat],
          "orc")
      } else {
        sessionCatalog.metastoreCatalog.convertToLogicalRelation(
          relation,
          options,
          classOf[org.apache.spark.daslab.sql.hive.orc.OrcFileFormat],
          "orc")
      }
    }
  }

...
import org.apache.spark.daslab.sql.engine.encoders.{encoderFor, ExpressionEncoder}
import org.apache.spark.daslab.sql.engine.expressions.{Alias, Attribute, CreateStruct}
import org.apache.spark.daslab.sql.engine.plans.logical._
import org.apache.spark.daslab.sql.execution.QueryExecution
import org.apache.spark.daslab.sql.expressions.ReduceAggregator
import org.apache.spark.daslab.sql.streaming.{GroupState, GroupStateTimeout, OutputMode}

//todo java
import org.apache.spark.daslab.api.java.function._
...
class KeyValueGroupedDataset[K, V] private[sql](
   ...
   * See [[org.apache.spark.daslab.sql.streaming.GroupState]] for more details.
   *

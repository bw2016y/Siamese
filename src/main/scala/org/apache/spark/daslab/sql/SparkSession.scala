...
import org.apache.spark.daslab.sql.catalog.Catalog
...
import org.apache.spark.daslab.sql.engine.plans.logical.{LocalRelation, Range}
import org.apache.spark.daslab.sql.execution._
import org.apache.spark.daslab.sql.execution.datasources.LogicalRelation
import org.apache.spark.daslab.sql.internal._
...
import org.apache.spark.daslab.sql.util.ExecutionListenerManager
...
class SparkSession private(
   ...
   * functions, and everything else that accepts a [[org.apache.spark.daslab.sql.internal.SQLConf]].
  ...
  /**
   * :: Experimental ::
   * An interface to register custom [[org.apache.spark.daslab.sql.util.QueryExecutionListener]]s
   ...
   *  val sparkSession = new org.apache.spark.daslab.sql.SparkSession(sc)
   *
   *  val schema =
   *    StructType(

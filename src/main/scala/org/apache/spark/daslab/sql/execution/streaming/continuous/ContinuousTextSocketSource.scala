...
import org.apache.spark.daslab.sql.execution.streaming.{ContinuousRecordEndpoint, ContinuousRecordPartitionOffset, GetRecord}
import org.apache.spark.daslab.sql.execution.streaming.sources.TextSocketReader
...
import org.apache.spark.daslab.sql.sources.v2.reader.streaming.{ContinuousInputPartitionReader, ContinuousReader, Offset, PartitionOffset}

...
package org.apache.spark.daslab.sql.hive.test
...
import org.apache.spark.daslab.sql.engine.analysis.UnresolvedRelation
import org.apache.spark.daslab.sql.engine.catalog.{ExternalCatalog, ExternalCatalogWithListener}
import org.apache.spark.daslab.sql.engine.optimizer.ConvertToLocalRelation
import org.apache.spark.daslab.sql.engine.plans.logical.{LogicalPlan, OneRowRelation}
import org.apache.spark.daslab.sql.execution.{QueryExecution, SQLExecution}
import org.apache.spark.daslab.sql.execution.command.CacheTableCommand
import org.apache.spark.daslab.sql.hive._
import org.apache.spark.daslab.sql.hive.client.HiveClient
import org.apache.spark.daslab.sql.internal.{SessionState, SharedState, SQLConf, WithTestConf}
import org.apache.spark.daslab.sql.internal.StaticSQLConf.CATALOG_IMPLEMENTATION
    ...
    new SparkContext(
      ...
      new SparkConf()
        ...
        .set("spark.sql.hive.metastore.barrierPrefixes",
          "org.apache.spark.daslab.sql.hive.execution.PairSerDe")
    ...
    val hiveQTestUtilTables: Seq[TestTable] = Seq(
      ...
      TestTable("src_thrift", () => {
        ...
        s"""
           ...
           |  'serialization.class'='org.apache.spark.daslab.sql.hive.test.Complex',

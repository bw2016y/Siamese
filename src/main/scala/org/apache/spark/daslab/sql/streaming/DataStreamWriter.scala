...
import org.apache.spark.daslab.sql.execution.streaming.sources._
...
final class DataStreamWriter[T] private[sql](ds: Dataset[T]) {
   ...
   * object. See [[org.apache.spark.daslab.sql.ForeachWriter]] for more details on the lifecycle and
   * semantics.
   * @since 2.0.0
   */

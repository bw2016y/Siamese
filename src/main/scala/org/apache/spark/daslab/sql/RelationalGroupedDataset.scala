...
import org.apache.spark.daslab.sql.engine.analysis.{Star, UnresolvedAlias, UnresolvedAttribute, UnresolvedFunction}
...
import org.apache.spark.daslab.sql.engine.util.toPrettySQL
import org.apache.spark.daslab.sql.execution.aggregate.TypedAggregateExpression
import org.apache.spark.daslab.sql.internal.SQLConf
import org.apache.spark.daslab.sql.types.{NumericType, StructType}
...
class RelationalGroupedDataset protected[sql](
   ...
   *
   * The available aggregate methods are defined in [[org.apache.spark.daslab.sql.functions]].
   *
   * {{{
   *   // Selects the age of the oldest employee and the aggregate expense for each department
   *
   ...
   * `org.apache.spark.daslab.sql.expressions#Aggregator`.
   *

...
import org.apache.spark.daslab.sql.engine._
import org.apache.spark.daslab.sql.engine.analysis._
import org.apache.spark.daslab.sql.engine.catalog.HiveTableRelation
import org.apache.spark.daslab.sql.engine.encoders._
import org.apache.spark.daslab.sql.engine.expressions._
import org.apache.spark.daslab.sql.engine.expressions.codegen.GenerateSafeProjection
import org.apache.spark.daslab.sql.engine.json.{JacksonGenerator, JSONOptions}
import org.apache.spark.daslab.sql.engine.optimizer.CombineUnions
import org.apache.spark.daslab.sql.engine.parser.{ParseException, ParserUtils}
import org.apache.spark.daslab.sql.engine.plans._
import org.apache.spark.daslab.sql.engine.plans.logical._
import org.apache.spark.daslab.sql.engine.plans.physical.{Partitioning, PartitioningCollection}
import org.apache.spark.daslab.sql.execution._
import org.apache.spark.daslab.sql.execution.arrow.{ArrowBatchStreamWriter, ArrowConverters}
import org.apache.spark.daslab.sql.execution.command._
import org.apache.spark.daslab.sql.execution.datasources.LogicalRelation
import org.apache.spark.daslab.sql.execution.python.EvaluatePython
import org.apache.spark.daslab.sql.execution.stat.StatFunctions
import org.apache.spark.daslab.sql.streaming.DataStreamWriter
import org.apache.spark.daslab.sql.types._
import org.apache.spark.daslab.sql.util.SchemaUtils
//todo
...
class Dataset[T] private[sql](
   ...
   *
   *   // Java:
   *   import static org.apache.spark.daslab.sql.functions.*;
  ...
  def join(right: Dataset[_], joinExprs: Column, joinType: String): DataFrame = {
    ...
    val cond = plan.condition.map { _.transform {
      case engine.expressions.EqualTo(a: AttributeReference, b: AttributeReference)
        if a.sameRef(b) =>
        engine.expressions.EqualTo(
          withPlan(plan.left).resolve(a.name),
          withPlan(plan.right).resolve(b.name))
      case engine.expressions.EqualNullSafe(a: AttributeReference, b: AttributeReference)
        if a.sameRef(b) =>
        engine.expressions.EqualNullSafe(
          withPlan(plan.left).resolve(a.name),
          withPlan(plan.right).resolve(b.name))
    }}

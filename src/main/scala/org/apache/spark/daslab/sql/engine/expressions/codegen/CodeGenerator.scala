...
import org.apache.spark.daslab.sql.engine.util.{ArrayData, GenericArrayData, MapData}
...
class CodegenContext {
   ...
   */
  private[engine] val inlinedMutableStates: mutable.ArrayBuffer[(String, String)] =
   ...
   * Exposed for tests only.
   */
  private[engine] val arrayCompactedMutableStates: mutable.Map[String, MutableStateArrays] =

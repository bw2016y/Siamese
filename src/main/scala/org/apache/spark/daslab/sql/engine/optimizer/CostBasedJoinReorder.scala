...
import org.apache.spark.daslab.sql.engine.expressions.{And, Attribute, AttributeSet, Expression, PredicateHelper}
import org.apache.spark.daslab.sql.engine.plans.{Inner, InnerLike, JoinType}
import org.apache.spark.daslab.sql.engine.plans.logical.{BinaryNode, Join, LogicalPlan, Project}

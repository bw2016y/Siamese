...
import org.apache.spark.daslab.sql.engine.analysis.{Resolver, TypeCoercion}
import org.apache.spark.daslab.sql.engine.catalog.CatalogTypes.TablePartitionSpec
import org.apache.spark.daslab.sql.engine.expressions.{Attribute, Cast, Literal}
...
object PartitioningUtils {
  ...
  import org.apache.spark.daslab.sql.engine.catalog.ExternalCatalogUtils.DEFAULT_PARTITION_NAME
  import org.apache.spark.daslab.sql.engine.catalog.ExternalCatalogUtils.escapePathName
  import org.apache.spark.daslab.sql.engine.catalog.ExternalCatalogUtils.unescapePathName
  ...
  private[datasources] def inferPartitionColumnValue(
    ...
    val dateTry = Try {
      ...
      // org.apache.spark.daslab.sql.execution.datasources.PartitioningAwareFileIndex.inferPartitioning)
  ...
  private def columnNameEquality(caseSensitive: Boolean): (String, String) => Boolean = {
    if (caseSensitive) {
      org.apache.spark.daslab.sql.engine.analysis.caseSensitiveResolution
    } else {
      org.apache.spark.daslab.sql.engine.analysis.caseInsensitiveResolution
    }
  }

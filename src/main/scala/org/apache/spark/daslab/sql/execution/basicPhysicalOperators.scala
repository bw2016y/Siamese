...
import org.apache.spark.daslab.sql.internal.{SQLConf, StaticSQLConf}
 ...
 */
case class RangeExec(range: org.apache.spark.daslab.sql.engine.plans.logical.Range)
  ...
  override def doCanonicalize(): SparkPlan = {
    RangeExec(range.canonicalized.asInstanceOf[org.apache.spark.daslab.sql.engine.plans.logical.Range])
  }
 ...
 * [[org.apache.spark.daslab.sql.engine.plans.logical.Union.maxRowsPerPartition]].
 */

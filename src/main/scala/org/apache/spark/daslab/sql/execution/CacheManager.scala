...
import org.apache.spark.daslab.sql.engine.expressions.SubqueryExpression
import org.apache.spark.daslab.sql.engine.plans.logical.{LogicalPlan, ResolvedHint}
...
class CacheManager extends Logging {
   ...
   * [[org.apache.spark.daslab.sql.execution.datasources.FileIndex]] of any [[HadoopFsRelation]] nodes

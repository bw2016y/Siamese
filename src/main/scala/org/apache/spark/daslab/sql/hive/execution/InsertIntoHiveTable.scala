...
package org.apache.spark.daslab.sql.hive.execution
...
import org.apache.spark.daslab.sql.engine.catalog.{CatalogTable, CatalogTableType, ExternalCatalog, ExternalCatalogUtils}
...
import org.apache.spark.daslab.sql.execution.command.CommandUtils
import org.apache.spark.daslab.sql.hive.HiveShim.{ShimFileSinkDesc => FileSinkDesc}
import org.apache.spark.daslab.sql.hive.client.HiveClientImpl
 ...
 * as defined in `org.apache.spark.daslab.sql.execution.datasources.FileFormatWriter`.
 *

...
import org.apache.spark.daslab.sql.{ExperimentalMethods, SparkSession, UDFRegistration, _}
import org.apache.spark.daslab.sql.engine.analysis.{Analyzer, FunctionRegistry}
...
import org.apache.spark.daslab.sql.execution.{QueryExecution, SparkOptimizer, SparkPlanner, SparkSqlParser}
import org.apache.spark.daslab.sql.execution.datasources._
import org.apache.spark.daslab.sql.streaming.StreamingQueryManager

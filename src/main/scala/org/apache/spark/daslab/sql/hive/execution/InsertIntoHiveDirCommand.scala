...
case class InsertIntoHiveDirCommand(
  ...
  override def run(sparkSession: SparkSession, child: SparkPlan): Seq[Row] = {
    ...
    val hiveTable = HiveClientImpl.toHiveTable(CatalogTable(
      ...
      tableType = org.apache.spark.daslab.sql.engine.catalog.CatalogTableType.VIEW,
      storage = storage,
    ...
    val fileSinkConf = new org.apache.spark.daslab.sql.hive.HiveShim.ShimFileSinkDesc(

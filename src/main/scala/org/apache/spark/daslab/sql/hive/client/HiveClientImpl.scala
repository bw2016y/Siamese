...
package org.apache.spark.daslab.sql.hive.client
...
import org.apache.spark.daslab.sql.engine.analysis.{NoSuchDatabaseException, NoSuchPartitionException}
...
import org.apache.spark.daslab.sql.engine.parser.{CatalystSqlParser, ParseException}
import org.apache.spark.daslab.sql.execution.QueryExecutionException
import org.apache.spark.daslab.sql.hive.HiveExternalCatalog
import org.apache.spark.daslab.sql.hive.HiveExternalCatalog.{DATASOURCE_SCHEMA, DATASOURCE_SCHEMA_NUMPARTS, DATASOURCE_SCHEMA_PART_PREFIX}
import org.apache.spark.daslab.sql.hive.client.HiveClientImpl._

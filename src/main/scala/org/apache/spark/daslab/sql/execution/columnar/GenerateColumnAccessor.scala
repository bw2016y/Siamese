...
import org.apache.spark.daslab.sql.engine.expressions.codegen.{CodeAndComment, CodeFormatter, CodeGenerator, UnsafeRowWriter}
...
object GenerateColumnAccessor extends CodeGenerator[Seq[DataType], ColumnarIterator] with Logging {
  ...
  protected def create(columnTypes: Seq[DataType]): ColumnarIterator = {
    ...
    val codeBody = s"""
      ...
      import org.apache.spark.daslab.sql.engine.expressions.codegen.BufferHolder;
      import org.apache.spark.daslab.sql.engine.expressions.codegen.UnsafeRowWriter;
      import org.apache.spark.daslab.sql.execution.columnar.MutableUnsafeRow;

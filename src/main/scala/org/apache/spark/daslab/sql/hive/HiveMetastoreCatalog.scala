...
import org.apache.spark.daslab.sql.engine.{QualifiedTableName, TableIdentifier}
...
import org.apache.spark.daslab.sql.internal.SQLConf.HiveCaseSensitiveInferenceMode._

...
import org.apache.spark.daslab.sql.execution.{ProjectionOverSchema, SelectedField}
...
import org.apache.spark.daslab.sql.types.{ArrayType, DataType, MapType, StructField, StructType}

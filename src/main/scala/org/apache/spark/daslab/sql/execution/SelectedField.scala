...
/**
 * A Scala extractor that builds a [[org.apache.spark.daslab.sql.types.StructField]] from a Catalyst
 ...
 * }}}
 *
 * by mapping each complex type extractor to a [[org.apache.spark.daslab.sql.types.StructField]] with the
 ...
 * is "name" and its data type is a [[org.apache.spark.daslab.sql.types.StructType]] with a single string
 * field named "first".
 *

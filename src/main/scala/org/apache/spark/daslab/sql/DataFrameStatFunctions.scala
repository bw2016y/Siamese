...
import org.apache.spark.daslab.sql.execution.stat._
import org.apache.spark.daslab.sql.functions.col
...
final class DataFrameStatFunctions private[sql](df: DataFrame) {
  ...
  def sampleBy[T](col: String, fractions: Map[T, Double], seed: Long): DataFrame = {
    ...
    import org.apache.spark.daslab.sql.functions.{rand, udf}
    val c = Column(col)
    val r = rand(seed)

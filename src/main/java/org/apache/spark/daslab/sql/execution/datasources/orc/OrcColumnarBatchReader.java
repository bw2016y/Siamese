...
public class OrcColumnarBatchReader extends RecordReader<Void, ColumnarBatch> {
    ...
    private org.apache.spark.daslab.sql.vectorized.ColumnVector[] orcVectorWrappers;
    ...
    public void initBatch(
        ...
        if (copyToSpark) {
            ...
            orcVectorWrappers = new org.apache.spark.daslab.sql.vectorized.ColumnVector[resultSchema.length()];

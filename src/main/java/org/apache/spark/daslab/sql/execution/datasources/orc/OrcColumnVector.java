...
import org.apache.spark.daslab.sql.types.TimestampType;
 ...
 */
public class OrcColumnVector extends org.apache.spark.daslab.sql.vectorized.ColumnVector {
    ...
    @Override
    public org.apache.spark.daslab.sql.vectorized.ColumnVector getChild(int ordinal) {
        throw new UnsupportedOperationException();
    }
}

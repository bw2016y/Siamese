...
public class PredictService {
  ...
  public interface Iface {
    ...
    public Errors predict(Plans sendMessages) throws org.apache.thrift.TException;

  }

  public interface AsyncIface {

    public void predict(Plans sendMessages, org.apache.thrift.async.AsyncMethodCallback<Errors> resultHandler) throws org.apache.thrift.TException;
  ...
  public static class Client extends org.apache.thrift.TServiceClient implements Iface {
    ...
    public Errors predict(Plans sendMessages) throws org.apache.thrift.TException
    {
      send_predict(sendMessages);
      return recv_predict();
    }

    public void send_predict(Plans sendMessages) throws org.apache.thrift.TException
    {
      predict_args args = new predict_args();
      args.setSendMessages(sendMessages);
      sendBase("predict", args);
    }

    public Errors recv_predict() throws org.apache.thrift.TException
    {
  ...
  public static class AsyncClient extends org.apache.thrift.async.TAsyncClient implements AsyncIface {
    ...
    public void predict(Plans sendMessages, org.apache.thrift.async.AsyncMethodCallback<Errors> resultHandler) throws org.apache.thrift.TException {
      checkReady();
      predict_call method_call = new predict_call(sendMessages, resultHandler, this, ___protocolFactory, ___transport);
      this.___currentMethod = method_call;
      ___manager.call(method_call);
    }

    public static class predict_call extends org.apache.thrift.async.TAsyncMethodCall<Errors> {
      private Plans sendMessages;
      public predict_call(Plans sendMessages, org.apache.thrift.async.AsyncMethodCallback<Errors> resultHandler, org.apache.thrift.async.TAsyncClient client, org.apache.thrift.protocol.TProtocolFactory protocolFactory, org.apache.thrift.transport.TNonblockingTransport transport) throws org.apache.thrift.TException {
      ...
      public Errors getResult() throws org.apache.thrift.TException {
  ...
  public static class Processor<I extends Iface> extends org.apache.thrift.TBaseProcessor<I> implements org.apache.thrift.TProcessor {
    ...
    public static class predict<I extends Iface> extends org.apache.thrift.ProcessFunction<I, predict_args> {
      ...
      public predict_result getResult(I iface, predict_args args) throws org.apache.thrift.TException {
        predict_result result = new predict_result();
        result.success = iface.predict(args.sendMessages);
        return result;
      }
    }
  ...
  public static class AsyncProcessor<I extends AsyncIface> extends org.apache.thrift.TBaseAsyncProcessor<I> {
    ...
    public static class predict<I extends AsyncIface> extends org.apache.thrift.AsyncProcessFunction<I, predict_args, Errors> {
      public predict() {
        super("predict");
      }
      ...
      public org.apache.thrift.async.AsyncMethodCallback<Errors> getResultHandler(final org.apache.thrift.server.AbstractNonblockingServer.AsyncFrameBuffer fb, final int seqid) {
        final org.apache.thrift.AsyncProcessFunction fcall = this;
        return new org.apache.thrift.async.AsyncMethodCallback<Errors>() { 
          public void onComplete(Errors o) {
            predict_result result = new predict_result();
            result.success = o;
            try {
      ...
      public void start(I iface, predict_args args, org.apache.thrift.async.AsyncMethodCallback<Errors> resultHandler) throws org.apache.thrift.TException {
        iface.predict(args.sendMessages,resultHandler);
      }
    }
  ...
  public static class predict_args implements org.apache.thrift.TBase<predict_args, predict_args._Fields>, java.io.Serializable, Cloneable, Comparable<predict_args>   {
    ...
    private static final org.apache.thrift.protocol.TField SEND_MESSAGES_FIELD_DESC = new org.apache.thrift.protocol.TField("sendMessages", org.apache.thrift.protocol.TType.STRUCT, (short)1);
    ...
    public @org.apache.thrift.annotation.Nullable Plans sendMessages; // required

    /** The set of fields this struct contains, along with convenience methods for finding and manipulating them. */
    public enum _Fields implements org.apache.thrift.TFieldIdEnum {
      SEND_MESSAGES((short)1, "sendMessages");
    ...
    static {
      ...
      tmpMap.put(_Fields.SEND_MESSAGES, new org.apache.thrift.meta_data.FieldMetaData("sendMessages", org.apache.thrift.TFieldRequirementType.REQUIRED, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, Plans.class)));
    ...
    public predict_args(predict_args other) {
      if (other.isSetSendMessages()) {
        this.sendMessages = new Plans(other.sendMessages);
      }
    }
    ...
    @org.apache.thrift.annotation.Nullable
    public Plans getSendMessages() {
      return this.sendMessages;
    }

    public predict_args setSendMessages(@org.apache.thrift.annotation.Nullable Plans sendMessages) {
      this.sendMessages = sendMessages;
      return this;
    }

    public void unsetSendMessages() {
      this.sendMessages = null;
    }

    /** Returns true if field sendMessages is set (has been assigned a value) and false otherwise */
    public boolean isSetSendMessages() {
      return this.sendMessages != null;
    }

    public void setSendMessagesIsSet(boolean value) {
      if (!value) {
        this.sendMessages = null;
      }
    }
    ...
    public boolean equals(predict_args that) {
      ...
      boolean this_present_sendMessages = true && this.isSetSendMessages();
      boolean that_present_sendMessages = true && that.isSetSendMessages();
      if (this_present_sendMessages || that_present_sendMessages) {
        if (!(this_present_sendMessages && that_present_sendMessages))
          return false;
        if (!this.sendMessages.equals(that.sendMessages))
          return false;
      }
    ...
    public int hashCode() {
      ...
      hashCode = hashCode * 8191 + ((isSetSendMessages()) ? 131071 : 524287);
      if (isSetSendMessages())
        hashCode = hashCode * 8191 + sendMessages.hashCode();
    ...
    public int compareTo(predict_args other) {
      ...
      lastComparison = Boolean.valueOf(isSetSendMessages()).compareTo(other.isSetSendMessages());
      if (lastComparison != 0) {
        return lastComparison;
      }
      if (isSetSendMessages()) {
        lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.sendMessages, other.sendMessages);
        if (lastComparison != 0) {
          return lastComparison;
        }
      }
    ...
    public void validate() throws org.apache.thrift.TException {
      ...
      if (sendMessages == null) {
        throw new org.apache.thrift.protocol.TProtocolException("Required field 'sendMessages' was not present! Struct: " + toString());
      }
    ...
    private static class predict_argsStandardScheme extends org.apache.thrift.scheme.StandardScheme<predict_args> {
          ...
          switch (schemeField.id) {
            case 1: // SEND_MESSAGES
              if (schemeField.type == org.apache.thrift.protocol.TType.STRUCT) {
                struct.sendMessages = new Plans();
                struct.sendMessages.read(iprot);
                struct.setSendMessagesIsSet(true);
              } else { 
      ...
      public void write(org.apache.thrift.protocol.TProtocol oprot, predict_args struct) throws org.apache.thrift.TException {
        ...
        if (struct.sendMessages != null) {
          oprot.writeFieldBegin(SEND_MESSAGES_FIELD_DESC);
          struct.sendMessages.write(oprot);
          oprot.writeFieldEnd();
        }
  ...
  public static class predict_result implements org.apache.thrift.TBase<predict_result, predict_result._Fields>, java.io.Serializable, Cloneable, Comparable<predict_result>   {
    ...
    public @org.apache.thrift.annotation.Nullable Errors success; // required
    ...
    static {
      ...
      tmpMap.put(_Fields.SUCCESS, new org.apache.thrift.meta_data.FieldMetaData("success", org.apache.thrift.TFieldRequirementType.DEFAULT, 
          new org.apache.thrift.meta_data.StructMetaData(org.apache.thrift.protocol.TType.STRUCT, Errors.class)));
      metaDataMap = java.util.Collections.unmodifiableMap(tmpMap);
    ...
    public predict_result(predict_result other) {
      if (other.isSetSuccess()) {
        this.success = new Errors(other.success);
      }
    }
    ...
    @org.apache.thrift.annotation.Nullable
    public Errors getSuccess() {
      return this.success;
    }

    public predict_result setSuccess(@org.apache.thrift.annotation.Nullable Errors success) {
      this.success = success;
      return this;
    }
